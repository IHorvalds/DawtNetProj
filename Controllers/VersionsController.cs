...
namespace DawtNetProject.Models
{
    public class VersionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,VersionNumber,Title,ContentPath")] Version version)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,VersionNumber,Title,ContentPath")] Version version)
        {
            if (ModelState.IsValid)
            {
